...
if __name__ == '__main__':
    # file path: the pruned test data by slimcode, eg: data/codesearch/slimcode/codebert/10/test.txt
    file_path='data/codesearch/slimcode/codebert/10/test.txt'
    preprocess_test_data_new(file_path)
