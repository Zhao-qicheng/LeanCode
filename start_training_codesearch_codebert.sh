...
LOGFILE="$LOGDIR/codesearch_training_${TIMESTAMP}.log"
...
tmux new-session -d -s codesearch "
    source ~/.bashrc
...
echo ""
echo "✓ 训练已在 tmux 会话 'codesearch' 中启动"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📋 查看日志："
...
echo ""
echo "🔧 管理会话："
echo "  进入会话: tmux attach -t codesearch"
echo "  查看所有会话: tmux ls"
echo "  分离会话: 在会话内按 Ctrl+B 然后按 D"
echo "  停止训练: tmux kill-session -t codesearch"
echo ""
echo "📊 查看进程状态："
