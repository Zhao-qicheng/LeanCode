...
//            double allRemovePercent = 0;
            ...
            for(int i=0; i < stringList.size();i++){
                ...
                if (flg==0){
                    //code search data (5 fields: code, nl, url, tokens, map)
                    code = codeList[0];
                    allTokensStr = codeList[3];
                    wordToSubtokenMapStr = codeList[4];
                }
                else {
                    //code summarization data (4 fields: code, nl, tokens, map - NO URL!)
                    code = codeList[0];
...
//                int originLength = code.split(" +").length;
                try {
                    ...
                    // Both cases update index 0 (code is always at position 0)
                    codeList[0] = code;
...
//            System.out.println("cut:"+code.split(" +").length);
    ...
    public static void main(String[] args) {
        // CodeSearch data already completed, skip it
        /*
        ratio=0.9;
        prune("slimcode/data/codesearch/test_with_tokens.txt","data/codesearch/slimcode/codet5/10/test.txt",0);
        ratio=0.8;
        prune("slimcode/data/codesearch/test_with_tokens.txt","data/codesearch/slimcode/codet5/20/test.txt",0);
        ratio=0.7;
        prune("slimcode/data/codesearch/test_with_tokens.txt","data/codesearch/slimcode/codet5/30/test.txt",0);
        ratio=0.6;
        prune("slimcode/data/codesearch/test_with_tokens.txt","data/codesearch/slimcode/codet5/40/test.txt",0);
        ratio=0.5;
        prune("slimcode/data/codesearch/test_with_tokens.txt","data/codesearch/slimcode/codet5/50/test.txt",0);
        ratio=0.9;
        prune("slimcode/data/codesearch/test_with_tokens_codebert.txt","data/codesearch/slimcode/codebert/10/test.txt",0);
        ratio=0.8;
        prune("slimcode/data/codesearch/test_with_tokens_codebert.txt","data/codesearch/slimcode/codebert/20/test.txt",0);
        ratio=0.7;
        prune("slimcode/data/codesearch/test_with_tokens_codebert.txt","data/codesearch/slimcode/codebert/30/test.txt",0);
        ratio=0.6;
        prune("slimcode/data/codesearch/test_with_tokens_codebert.txt","data/codesearch/slimcode/codebert/40/test.txt",0);
        ratio=0.5;
        prune("slimcode/data/codesearch/test_with_tokens_codebert.txt","data/codesearch/slimcode/codebert/50/test.txt",0);
        */
        
        //        process test data for code summarization on CodeT5
        ratio=0.9;
        prune("slimcode/data/code2nl/test_with_tokens.txt","data/code2nl/slimcode/codet5/10/test.txt",1);
        ratio=0.8;
        prune("slimcode/data/code2nl/test_with_tokens.txt","data/code2nl/slimcode/codet5/20/test.txt",1);
        ratio=0.7;
        prune("slimcode/data/code2nl/test_with_tokens.txt","data/code2nl/slimcode/codet5/30/test.txt",1);
        ratio=0.6;
        prune("slimcode/data/code2nl/test_with_tokens.txt","data/code2nl/slimcode/codet5/40/test.txt",1);
        ratio=0.5;
        prune("slimcode/data/code2nl/test_with_tokens.txt","data/code2nl/slimcode/codet5/50/test.txt",1);
        //        process test data for code summarization on CodeBERT
        ratio=0.9;
        prune("slimcode/data/code2nl/test_with_tokens_codebert.txt","data/code2nl/slimcode/codebert/10/test.txt",1);
        ratio=0.8;
        prune("slimcode/data/code2nl/test_with_tokens_codebert.txt","data/code2nl/slimcode/codebert/20/test.txt",1);
        ratio=0.7;
        prune("slimcode/data/code2nl/test_with_tokens_codebert.txt","data/code2nl/slimcode/codebert/30/test.txt",1);
        ratio=0.6;
        prune("slimcode/data/code2nl/test_with_tokens_codebert.txt","data/code2nl/slimcode/codebert/40/test.txt",1);
        ratio=0.5;
        prune("slimcode/data/code2nl/test_with_tokens_codebert.txt","data/code2nl/slimcode/codebert/50/test.txt",1);
    }
}
